...
import com.example.crud.databinding.ActivityEditBinding
import kotlinx.coroutines.launch  // Don't forget to import launch
...
class EditActivity : AppCompatActivity() {
    ...
    fun getNote() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            binding.editNote.setText(notes.description)
        }
    }
